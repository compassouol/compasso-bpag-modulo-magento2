 ...
 *
 * @category Class
 * @description Dados de cobrança de pagamentos recorrentes
 * @package  Compasso\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SubscriptionRequest implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cycles'] === null) {
            $invalidProperties[] = "'cycles' can't be null";
        }
     ...
     * Sets cycle_type
     *
     * @param string $cycle_type Tipo de ciclo de cobrança recorrente
     *
     * @return $this
     */
     ...
     * Sets cycles
     *
     * @param int $cycles Número de ciclos que serão executados
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Data de início da cobrança recorrente
     *
     * @return $this
     */

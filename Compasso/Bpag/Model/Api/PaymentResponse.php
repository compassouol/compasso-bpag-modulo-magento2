...
class PaymentResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'date' => '\DateTime',
        'id' => 'string',
        'payment_method' => '\Compasso\Bpag\Model\Api\MeioDePagamento',
        'subscription' => '\Compasso\Bpag\Model\Api\SubscriptionResponse',
        'token' => '\Compasso\Bpag\Model\Api\TokenResponse',
        'transactions' => '\Compasso\Bpag\Model\Api\TransactionResponse[]'
    ];
     ...
     * Sets balance
     *
     * @param int $balance Saldo = Valor - Pago
     *
     * @return $this
     */
     ...
     * Sets date
     *
     * @param \DateTime $date Data do pagamento no formato ISO 8601
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Identificador único do pagamento
     *
     * @return $this
     */
     ...
     * Gets payment_method
     *
     * @return \Compasso\Bpag\Model\Api\MeioDePagamento
     */
     ...
     * Sets payment_method
     *
     * @param \Compasso\Bpag\Model\Api\MeioDePagamento $payment_method Meio de pagamento
     *
     * @return $this
     */
     ...
     * Gets subscription
     *
     * @return \Compasso\Bpag\Model\Api\SubscriptionResponse
     */
     ...
     * Sets subscription
     *
     * @param \Compasso\Bpag\Model\Api\SubscriptionResponse $subscription Recorrencia
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \Compasso\Bpag\Model\Api\TokenResponse $token Token de cartão
     *
     * @return $this
     */
     ...
     * Gets transactions
     *
     * @return \Compasso\Bpag\Model\Api\TransactionResponse[]
     */
     ...
     * Sets transactions
     *
     * @param \Compasso\Bpag\Model\Api\TransactionResponse[] $transactions Transações
     *
     * @return $this
     */

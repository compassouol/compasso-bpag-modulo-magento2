...
class SubscriptionResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'occurrences' => '\Compasso\Bpag\Model\Api\OccurrenceResponse[]',
        'start_date' => '\DateTime',
        'status' => 'string'
    ];
    ...
    const CYCLE_TYPE_UNKNOWN = 'UNKNOWN';
    const CYCLE_TYPE_MINUTE = 'MINUTE';
    const CYCLE_TYPE_HOUR = 'HOUR';
    const CYCLE_TYPE_DAILY = 'DAILY';
    const CYCLE_TYPE_WEEKLY = 'WEEKLY';
    const CYCLE_TYPE_MONTHLY = 'MONTHLY';
    const CYCLE_TYPE_YEARLY = 'YEARLY';
    ...
    {
        return [
            self::CYCLE_TYPE_UNKNOWN,
            self::CYCLE_TYPE_MINUTE,
            self::CYCLE_TYPE_HOUR,
     ...
     * Sets cycle_type
     *
     * @param string $cycle_type Tipo do ciclo
     *
     * @return $this
     */
     ...
     * Sets cycles
     *
     * @param int $cycles Quantidade de ciclos
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string $id Identificador único da recorrencia
     *
     * @return $this
     */
     ...
     *
     * @param \DateTime $next_cycle_date Data do próximo ciclo
     *
     * @return $this
     */
     ...
     * Gets occurrences
     *
     * @return \Compasso\Bpag\Model\Api\OccurrenceResponse[]
     */
     ...
     * Sets occurrences
     *
     * @param \Compasso\Bpag\Model\Api\OccurrenceResponse[] $occurrences Ocorrencias
     *
     * @return $this
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Data de início
     *
     * @return $this
     */

...
class CustomerRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'addresses' => '\Compasso\Bpag\Model\Api\AddressRequest[]',
        'birthday' => '\DateTime',
        'document' => 'string',
        ...
        'middle_name' => 'string',
        'phones' => '\Compasso\Bpag\Model\Api\PhoneRequest[]',
        'type' => 'string'
    ];
     ...
     * Gets addresses
     *
     * @return \Compasso\Bpag\Model\Api\AddressRequest[]
     */
     ...
     * Sets addresses
     *
     * @param \Compasso\Bpag\Model\Api\AddressRequest[] $addresses Endereços
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param string $last_name ÚItimo nome
     *
     * @return $this
     */
     ...
     * Gets phones
     *
     * @return \Compasso\Bpag\Model\Api\PhoneRequest[]
     */
     ...
     * Sets phones
     *
     * @param \Compasso\Bpag\Model\Api\PhoneRequest[] $phones Telefones
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Tipo do cliente
     *
     * @return $this
     */

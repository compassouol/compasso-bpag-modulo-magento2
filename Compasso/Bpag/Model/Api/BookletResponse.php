...
/**
 * BookletResponse Class Doc Comment
 *
 * @category Class
 * @package  Compasso\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BookletResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BookletResponse';
    ...
    protected static $swaggerFormats = [
        'additional_fi_data' => null,
        'integrator_code' => null,
        'raw_code' => null,
        'raw_message' => null,
        'url' => null
    ];
    ...
    protected static $attributeMap = [
        'additional_fi_data' => 'additionalFiData',
    ...
    protected static $setters = [
        'additional_fi_data' => 'setAdditionalFiData',
        'integrator_code' => 'setIntegratorCode',
        'raw_code' => 'setRawCode',
    ...
    protected static $getters = [
        'additional_fi_data' => 'getAdditionalFiData',
        'integrator_code' => 'getIntegratorCode',
        'raw_code' => 'getRawCode',
    ...
    {
        $this->container['additional_fi_data'] = isset($data['additional_fi_data']) ? $data['additional_fi_data'] : null;
        $this->container['integrator_code'] = isset($data['integrator_code']) ? $data['integrator_code'] : null;
        $this->container['raw_code'] = isset($data['raw_code']) ? $data['raw_code'] : null;
        $this->container['raw_message'] = isset($data['raw_message']) ? $data['raw_message'] : null;
    ...
    /**
     * Gets additional_fi_data
     *
     * @return object
     */
    public function getAdditionalFiData()
    {
        return $this->container['additional_fi_data'];
    }

    /**
     * Sets additional_fi_data
     *
     * @param object $additional_fi_data Dados adicionais da instituição financeira
     *
     * @return $this
     */
    public function setAdditionalFiData($additional_fi_data)
    {
        $this->container['additional_fi_data'] = $additional_fi_data;

        return $this;
    }

    /**
     * Gets integrator_code
     *
     * @return string
     */
    public function getIntegratorCode()
    {
        return $this->container['integrator_code'];
    }

    /**
     * Sets integrator_code
     *
     * @param string $integrator_code Código de integração
     *
     * @return $this
     */
    public function setIntegratorCode($integrator_code)
    {
        $this->container['integrator_code'] = $integrator_code;
    ...
    {
        return $this->container['raw_code'];
    }

    /**
     * Sets raw_code
     *
     * @param string $raw_code Código retornado pela instituição financeira
     *
     * @return $this
     */
    public function setRawCode($raw_code)
    {
        $this->container['raw_code'] = $raw_code;
     ...
     * Sets raw_message
     *
     * @param string $raw_message Mensagem retornada pela instituição financeira
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string $url Url para obtenção do boleto
     *
     * @return $this
     */

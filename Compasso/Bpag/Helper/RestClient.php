...
class RestClient implements \Iterator, \ArrayAccess {
    ...
    public function offsetSet($key, $value){
        throw new \Compasso\Bpag\Helper\RestClientException("Decoded response data is immutable.");
    }
    ...
    public function get_response_format(){
        if(!$this->response)
            throw new \Compasso\Bpag\Helper\RestClientException("A response must exist before it can be decoded.");
        ...
        throw new \Compasso\Bpag\Helper\RestClientException(
    ...
    public function decode_response(){
        if(empty($this->decoded_response)){
            ...
            if(!array_key_exists($format, $this->options['decoders']))
                throw new \Compasso\Bpag\Helper\RestClientException("'${format}' is not a supported ".

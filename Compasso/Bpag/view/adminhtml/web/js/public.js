...
var WS = {
    ...
    'Ajax' : {
        ...
        'Conciliation' : {
            ...
            {
                jQuery.ajax( {
                    url: url + '/bpag/conciliation/request',
                    ...
                    if (response.success) {
                        ...
                        var t = jQuery('#compasso-bpag-datatable').DataTable();
            ...
            {
                var t    = jQuery('#compasso-bpag-datatable').DataTable();
                var rows = jQuery('#compasso-bpag-datatable').find('[data-target=conciliation]:checked');
                ...
                jQuery.ajax( {
                    url: url + '/bpag/conciliation/conciliate',
        ...
        'Abandoned' : {
            ...
            'Search': function (url) {
                ...
                jQuery.ajax({
                    url: url + '/bpag/abandoned/request',
            ...
            {
                var t    = jQuery('#compasso-bpag-datatable').DataTable();
                var rows = jQuery('#compasso-bpag-datatable').find('[data-target=abandoned]:checked');
                ...
                jQuery.ajax( {
                    url: url + '/bpag/abandoned/transport',
                    data: {form_key: window.FORM_KEY, data: data},
                    type: 'POST',
                    showLoader: true,
                }).success(function(response) {
        ...
        'Cancellation' : {
            ...
            {
                jQuery.ajax( {
                    url: url + '/bpag/cancellation/request',
            ...
            'Cancel' : function(url, data, row)
            {
                ...
                jQuery.ajax( {
                    url: url + '/bpag/cancellation/cancel',
                    data: {form_key: window.FORM_KEY, data: data},
                    type: 'POST',
                    showLoader: true,
                }).success(function(response) {
        ...
        'Transactions' : {
            ...
            {
                jQuery.ajax( {
                    url: url + '/bpag/transactions/request',
                    data: {
            ...
            'Details' : function (url, transaction_code, order) {
                jQuery.ajax({
                    url: url + '/bpag/transactions/transaction',
                    type: "POST",
                    data: {
                        form_key: window.FORM_KEY,
